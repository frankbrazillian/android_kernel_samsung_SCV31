...
ARCH		?= arm64
SUBARCH        ?= arm64
CROSS_COMPILE	?= ../../aarch64-linaro-linux-android/bin/aarch64-linaro-linux-android-
...
HOSTCC       = $(CCACHE) gcc
HOSTCXX      = $(CCACHE) g++
HOSTCFLAGS   = -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 $(GRAPHITE)
...
KBUILD_CFLAGS   := -DNDEBUG -w -Wstrict-prototypes -Wno-trigraphs \
		   -fno-strict-aliasing -fno-common -finline-functions \
...
KBUILD_CFLAGS += $(call cc-disable-warning,maybe-unitialized,)
